...
/**
 * @Title: AverageCapitalPlusInterestUtils
 * @Description: 等额本息还款，也称定期付息，即借款人每月按相等的金额偿还贷款本息，其中每月贷款利息按月初剩余贷款本金计算并逐月结清。
 *               把按揭贷款的本金总额与利息总额相加，
 *               然后平均分摊到还款期限的每个月中。作为还款人，每个月还给银行固定金额，但每月还款额中的本金比重逐月递增、利息比重逐月递减。
 * @Author: zhaotf
 * @Since:2018年2月23日 下午7:11:15
 * @see {@linkplain http://blog.csdn.net/wzygis/article/details/51809575}
 */
