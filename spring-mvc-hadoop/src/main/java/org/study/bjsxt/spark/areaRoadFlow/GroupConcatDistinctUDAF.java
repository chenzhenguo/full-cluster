...
public class GroupConcatDistinctUDAF extends UserDefinedAggregateFunction {
	...
	public void update(MutableAggregationBuffer buffer, Row input) {
		// 缓冲中的已经拼接过的monitor信息字符串      |0001=2|0002=1
		String bufferMonitorInfo = buffer.getString(0);
		// 刚刚传递进来的monitor_id 0002
	 ...
	 * combiner1:|0001=10|0002=9|003=6
	 * combiner2:|0001=7|0002=3|0003=19
	 * 0001=17|0002=12|0003=25
	 */
	@Override
			...
			for (Entry<String, String> entry : map.entrySet()) {
				...
				if(oldVS == null) {
					if("".equals(bufferMonitorInfo1)) {
						...
						//bufferMonitorInfo1:0001=10
					} else {
						bufferMonitorInfo1 += "|" + monitor + "=" + carCount;
						//bufferMonitorInfo1:0001=10|0002=9
					}
	 			}else{
