...
/**
 * 
 * @Title: IGenericBaseCommonDao
 * @Description: DAO层泛型基类接口
 * @Author: zhaotf
 * @Since:2018年6月5日 下午2:33:46
 */
public interface IGenericBaseCommonDao {
	...
	// * @return
	// */
	// public PageList getPageList(final CriteriaQuery cq, final boolean
	// isOffset);
	...
	// * @return
	// */
	// public PageList getPageList(final HqlQuery hqlQuery, final boolean
	// needParameter);
	...
	// * @return
	// */
	// public PageList getPageListBySql(final HqlQuery hqlQuery, final boolean
	// needParameter);
	...
	// * @return
	// */
	// public DataTableReturn getDataTableReturn(final CriteriaQuery cq, final
	// boolean isOffset);
